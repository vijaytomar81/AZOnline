...
export const PAGE_SCANNER_DIR = path.join(TOOLS_DIR, "pageScanner");

export const PAGE_OBJECT_TOOLS_DIR = path.join(TOOLS_DIR, "pageObjects");
...
export const PAGE_ACTION_TOOLS_DIR = path.join(TOOLS_DIR, "pageActions");
...
export const QUALITY_TOOLS_DIR = path.join(TOOLS_DIR, "quality");
export const FILE_HEADER_CHECKER_DIR = path.join(
    QUALITY_TOOLS_DIR,
    "fileHeaderChecker"
);

export const SHARED_TOOLS_DIR = path.join(TOOLS_DIR, "shared");
