// src/pages/common/insurance-type-selection/InsuranceTypeSelectionPage.ts
...
const PAGE_KEY = "common.insurance-type-selection" as const;
...
export class InsuranceTypeSelectionPage extends basePage {
  ...
  async back2() {
  await this.clickAlias("back2");
  }

  async back3() {
  await this.clickAlias("back3");
  }

  async carQuote() {
  await this.clickAlias("carQuote");
  }

  async carQuote2() {
  await this.clickAlias("carQuote2");
  }

  async homeQuote() {
  await this.clickAlias("homeQuote");
  }

  async homeQuote2() {
  await this.clickAlias("homeQuote2");
  }

  async letUsKnow() {
  await this.clickAlias("letUsKnow");
  }
