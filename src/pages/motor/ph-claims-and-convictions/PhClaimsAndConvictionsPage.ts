// src/pages/motor/ph-claims-and-convictions/PhClaimsAndConvictionsPage.ts
...
const PAGE_KEY = "motor.ph-claims-and-convictions" as const;

export class PhClaimsAndConvictionsPage extends basePage {
