// src/pages/motor/ph-driving-licence-details/elements.ts
...
export const elements = {
  ...
  changeAddress: {
    type: "button",
    preferred: "role=button[name=/Change address/i]",
    fallbacks: ["text=/Change address/i"],
  },
  day: {
    type: "input",
  ...
  howLongHaveYouHeldYourLicenceFor: {
    type: "select",
  ...
  partialdrivinglicencenumberquestionmonthpart: {
    type: "input",
    preferred: "css=#partialDrivingLicenceNumberQuestionmonthPart",
    fallbacks: ["role=textbox[name=/partialDrivingLicenceNumberQuestionmonthPart/i]"],
  },
  partialdrivinglicencenumberquestionrandompart: {
    type: "input",
    preferred: "css=#partialDrivingLicenceNumberQuestionrandomPart",
    fallbacks: ["role=textbox[name=/partialDrivingLicenceNumberQuestionrandomPart/i]"],
  },
  reactSelect2Input: {
    type: "input",
