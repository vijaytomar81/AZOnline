// src/pages/motor/ad-driving-licence-details/AdDrivingLicenceDetailsPage.ts
...
const PAGE_KEY = "motor.ad-driving-licence-details" as const;

export class AdDrivingLicenceDetailsPage extends basePage {
  ...
  async additionaldriver1partialdrivinglicencenumberquestionmonthpart(value: string) {
  await this.fillAlias("additionaldriver1partialdrivinglicencenumberquestionmonthpart", value);
  }

  async additionaldriver1partialdrivinglicencenumberquestionrandompart(value: string) {
  await this.fillAlias("additionaldriver1partialdrivinglicencenumberquestionrandompart", value);
  }
  ...
  async addressOptional(value: string) {
  await this.selectOptionAlias("addressOptional", value);
  }
  ...
  async howLongHaveAdditionalDriverHeldLicenceFor(value: string) {
  await this.selectOptionAlias("howLongHaveAdditionalDriverHeldLicenceFor", value);
  }
  ...
  async reactSelect13Input(value: string) {
  await this.fillAlias("reactSelect13Input", value);
  }

  async reactSelect14Input(value: string) {
  await this.fillAlias("reactSelect14Input", value);
  }

  async reactSelect15Input(value: string) {
  await this.fillAlias("reactSelect15Input", value);
  }
