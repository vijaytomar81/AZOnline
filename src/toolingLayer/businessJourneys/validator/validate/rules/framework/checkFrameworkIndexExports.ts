// src/toolingLayer/businessJourneys/validator/validate/rules/framework/checkFrameworkIndexExports.ts
...
export function checkFrameworkIndexExports(): ValidationCheckResult {
    ...
    if (!fs.existsSync(filePath)) {
        issues.push({
            ...
            summary: "missing framework index file",
        });
    } else {
