...
```json
{
  ...
  "pageObjectImportPath": "@businessLayer/pageObjects/objects/athena/common/login-or-registration/LoginOrRegistrationPage",
  "elementCount": 4,
  "urlPath": "/",
  "title": "Login page"
}
...
```
@businessLayer/pageObjects/objects/athena/common/login-or-registration/LoginOrRegistrationPage
```
...
```json
{
  "@businessLayer/pageObjects/objects/*": ["src/pages/objects/*"]
}
```
