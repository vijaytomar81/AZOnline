// src/toolingLayer/pageObjects/validator/validate/rules/pageChain/checkGeneratedToBusinessAliases.ts
...
} from "@toolingLayer/pageObjects/common/extractTsObjectKeys";
