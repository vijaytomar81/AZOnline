// src/tools/pageObjects/validator/validate/rules/hygiene/moduleHygiene/collectIndexModuleHygieneIssues.ts
...
function hasPageObjectExport(indexTs: string): boolean {
    return (
        indexTs.includes(`export * from "@pageObjectsObjects/`) ||
