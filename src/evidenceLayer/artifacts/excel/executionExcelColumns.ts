...
const CORE_COLUMNS: ExecutionExcelColumn[] = [
    ...
    { header: "Platform", sourceKey: "platform", kind: "scenario" },
    { header: "Application", sourceKey: "application", kind: "scenario" },
    { header: "Product", sourceKey: "product", kind: "scenario" },
    {
        header: "Journey Start With",
        sourceKey: "journeyStartWith",
        kind: "scenario",
    },
    { header: "Policy Number", sourceKey: "policyNumber", kind: "scenario" },
    { header: "Login ID", sourceKey: "loginId", kind: "scenario" },
    { header: "Description", sourceKey: "description", kind: "scenario" },
    ...
    { header: "Sub Type", sourceKey: "subType", kind: "item" },
    { header: "Portal", sourceKey: "portal", kind: "item" },
