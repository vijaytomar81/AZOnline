// src/businessLayer/pageObjects/objects/athena/azonline/common/manage-cookies/ManageCookiesPage.ts
...
const PAGE_KEY = "athena.azonline.common.manage-cookies" as const;
