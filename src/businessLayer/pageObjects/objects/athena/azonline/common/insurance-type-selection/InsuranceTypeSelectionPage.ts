// src/businessLayer/pageObjects/objects/athena/azonline/common/insurance-type-selection/InsuranceTypeSelectionPage.ts
...
const PAGE_KEY = "athena.azonline.common.insurance-type-selection" as const;
