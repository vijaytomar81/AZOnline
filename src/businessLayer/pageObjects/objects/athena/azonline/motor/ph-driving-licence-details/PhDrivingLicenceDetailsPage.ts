// src/businessLayer/pageObjects/objects/athena/azonline/motor/ph-driving-licence-details/PhDrivingLicenceDetailsPage.ts
...
const PAGE_KEY = "athena.azonline.motor.ph-driving-licence-details" as const;
