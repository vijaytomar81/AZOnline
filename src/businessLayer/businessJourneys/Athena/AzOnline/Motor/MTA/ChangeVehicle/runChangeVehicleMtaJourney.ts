// src/businessLayer/businessJourneys/Athena/AzOnline/Motor/MTA/ChangeVehicle/runChangeVehicleMtaJourney.ts
...
export const runChangeVehicleMtaJourney: BusinessJourney = async ({
    context,
    payload,
}) => {
    ...
    await runJourney({
        steps: [
            // TODO: QA to add MTA / ChangeVehicle journey sequence.
            // Example:
            // async () => {
