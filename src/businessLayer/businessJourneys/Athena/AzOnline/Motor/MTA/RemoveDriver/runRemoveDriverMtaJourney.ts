// src/businessLayer/businessJourneys/Athena/AzOnline/Motor/MTA/RemoveDriver/runRemoveDriverMtaJourney.ts
...
export const runRemoveDriverMtaJourney: BusinessJourney = async ({
    context,
    payload,
}) => {
    ...
    await runJourney({
        steps: [
            // TODO: QA to add MTA / RemoveDriver journey sequence.
            // Example:
            // async () => {
