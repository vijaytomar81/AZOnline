// src/businessLayer/businessJourneys/Athena/AzOnline/Motor/MTC/runMTCJourney.ts
...
export const runMTCJourney: BusinessJourney = async ({
    context,
    payload,
}) => {
    ...
    await runJourney({
        steps: [
            // TODO: QA to add MTC journey sequence.
            // Example:
            // async () => {
